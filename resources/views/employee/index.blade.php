...
=> $employee->employee_id]) }}" class="btn btn-outline-dark btn-sm me2"><i class="bi-person-lines-fill"></i></a>
                                <a href="{{ route('employees.edit', ['employee'
=> $employee->employee_id]) }}" class="btn btn-outline-dark btn-sm me2"><i class="bi-pencil-square"></i></a>
                                <div>
